...
much = dogs
  .filter (d => {
    return d.curFood > d.recommendedFood;
  })
  .map (e => {
    return e.owners;
  })
...
console.log (much.join (' and ') + ' eat too much');
...
cd = [...dogs];
cd.sort ((a, b) => a.recommendedFood - b.recommendedFood);
console.log ('cd', cd);

x = BigInt (5555555555555555555555);
